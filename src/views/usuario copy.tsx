        ...
        <div className="w-full flex justify-between  flex-row  mb-2 ">
          <div className="relative w-80">
            <form action="/empresas">
              <input
                type="text"
                className="w-full py-2 pl-4 pr-4 text-sm text-gray-700 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-gray-300"
          ...
          <input
            ...
            className=" bg-[#3c6075] text-white  rounded-md pl-3 pr-3"
